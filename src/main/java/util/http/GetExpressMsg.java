...
import acomcode.enumeration.Method;
import acomcode.staticconstant.constant.Constants;
import acomcode.staticconstant.constant.HttpHeader;
import acomcode.staticconstant.constant.HttpSchema;
import util.http.Response;


/**
 * 
 *<p>Title	: GetExpressMsg</p>
 * @Description	: 获取物流信息
 * @author	: admin
 * @date	: 2017年11月21日下午8:27:38
 */
