/**   
* @Title: SimpleMailSenderUtil.java 
* @Package com.hello.admin.util 
* @Description: TODO(用一句话描述该文件做什么) 
* @author fanjianmin@xiangshang360.com   
* @date 2017年9月29日 下午5:47:23 
* @version V1.0   
*/
package util.admin;
...
/**
 * 
 *<p>Title	: SimpleMailSenderUtil</p>
 * @Description	: 发送邮件服务工具类
 * @author	: admin
 * @date	: 2017年11月21日下午8:35:02
 */
public class SimpleMailSenderUtil {
	
	
	private final static Log log=LogFactory.getLog(SimpleMailSenderUtil.class);
	/**   
	  * 以文本格式发送邮件   
