...
public class Tools {
	...
	public static boolean checkKey(String paraname, String FKEY){
		...
		return MD5.md5(paraname+DateUtil.getDays()+",hello,").equals(FKEY);
	}
	...
	public static String readTxtFile(String fileP) {
		try {
			String filePath = String.valueOf(Thread.currentThread().getContextClassLoader().getResource(""))+"../../src/main/webapp/";	//项目路径
