 ...
 * @Description	: 定时任务管理类
 * @author	: admin
 * @date	: 2017年11月21日下午8:34:10
 */
public class QuartzManager {  
    private static SchedulerFactory gSchedulerFactory = new StdSchedulerFactory();  //创建一个SchedulerFactory工厂实例
    private static String JOB_GROUP_NAME = "HELLO_JOBGROUP_NAME";  					//任务组
    private static String TRIGGER_GROUP_NAME = "HELLO_TRIGGERGROUP_NAME";  			//触发器组
