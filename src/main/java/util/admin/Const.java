...
public class Const {
	...
	public static final String NO_INTERCEPTOR_PATH = ".*/((login)|(adminLogout)|(code)|(app)|(weixin)|(static)|(main)|(websocket)|(uploadImgs)|(files)|(file)).*";	//不对匹配该值的访问路径拦截（正则）
