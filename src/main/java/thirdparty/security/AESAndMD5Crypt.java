...
public class AESAndMD5Crypt {
	...
	public static AESAndMD5Crypt getCrypt(){
		//向上协商给好的两个key
   	    String aesKey = (String) PropertieService.properties.get("xsjf.aesKey");
        String md5Key = (String) PropertieService.properties.get("xsjf.md5Key");
        return new AESAndMD5Crypt(md5Key, aesKey);
   }
