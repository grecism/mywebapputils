...
/**
 * 
 *<p>Title	: RedisClientTemplate</p>
 * @Description	: redis-client 操作的封装 依赖RedisDataSource
 * @author	: admin
 * @date	: 2017年11月22日上午9:28:49
 */
public class RedisClientTemplate {
	...
	/**
	 * 
	 * @Description : 使指定 key 在timeStemp时间点过期
	 * @param key
	...
	/**
	 * 
	 * @Description :  返回 key 中字符串值的子字符串，字符串的截取范围由 start 和 end 两个偏移量决定(包括 start 和 end 在内)。<br/>
	...
	/**
	 * 
	 * @Description : 将 key 的值设为 value ，当且仅当 key 不存在。<br/>
	...
	/**
	 * 
	 * @Description : 将值 value 关联到 key ，并将 key 的生存时间设为 seconds (以秒为单位)。<br/>
	...
	/**
	 * 
	 * @Description :  将给定 key 的值设为 value ，并返回 key 的旧值(old value)。<br/>
	...
	/**
	 * 
	 * @Description : 	 * 将 key 所储存的值减去减量 integer 。<br/>
	...
	/**
	 * 
	 * @Description : 将 key 中储存的数字值减一。<br/>
	...
	/**
	 * 
	 * @Description : 将 key 所储存的值加上增量 integer 。<br/>
	...
	/**
	 * 
	 * @Description : 将 key 中储存的数字值增一。<br/>
	...
	/**
	 * 
	 * @Description : 如果 key 已经存在并且是一个字符串， APPEND 命令将 value 追加到 key 原来的值的末尾。<br/>
	...
	/**
	 * 
	 * @Description : 将哈希表 key 中的域 field 的值设为 value 。<br/>
	...
	/**
	 * 
	 * @Description : 将哈希表 key 中的域 field 的值设置为 value ，当且仅当域 field 不存在。<br/>
	...
	/**
	 * 
	 * @Description : 将map设置到哈希表 key 中。 <br/>
	 * 此命令会覆盖哈希表中已存在的域。<br/>
	...
	/**
	 * 
	 * @Description : 返回哈希表 key 中，一个或多个给定域的值。<br/>
	...
	/**
	 * 
	 * @Description : 为哈希表 key 中的域 field 的值加上增量 value 。<br/>
	...
	/**
	 * 
	 * @Description : 删除哈希表 key 中的一个或多个指定域，不存在的域将被忽略。<br/>
	 * @param key
	 * @param field
	...
	/**
	 * 
	 * @Description : 返回哈希表 key 中，所有的域和值。<br/>
	...
	/**
	 * 
	 * @Description : 返回列表key 中指定区间内的元素,区间以偏移量 start 和 stop 指定。<br/>
	...
	/**
	 * 
	 * @Description : 将一个 member 元素加入到集合 key 当中，已经存在于集合的 member 元素将被忽略。<br/>
	...
	/**
	 * 
	 * @Description : 移除集合 key 中的一个 member 元素，不存在的 member 元素会被忽略。
	 * @param key
	 * @param member
	 * @return
	 */
	...
	/**
	 * 
	 * @Description : 将一个 member 元素及其 score 值加入到有序集 key 当中
	 * @param key
	 * @param score
	 * @param member
	 * @return
	...
	/**
	 * 
	 * @Description : 返回有序集 key 中，指定区间内的成员。<br/>
	...
	/**
	 * 
	 * @Description : 移除有序集 key 中的一个成员，不存在的成员将被忽略。
	 * @param key
	 * @param member
	 * @return
	 */
	...
	/**
	 * 
	 * @Description : 为有序集 key 的成员 member 的值加上增量 score
	 * @param key
	 * @param score
	 * @param member
	 * @return
	...
	/**
	 * 
	 * @Description :  返回有序集 key 中成员 member 的排名。其中有序集成员按 score 值递增(从小到大)顺序排列。<br/>
	...
	/**
	 * 
	 * @Description : 返回有序集 key 中成员 member 的排名。其中有序集成员按 score 值递减(从大到小)排序。<br/>
	...
	/**
	 * 
	 * @Description : 返回有序集 key 中，所有 score 值介于下标 start 和 end 之间的成员。有序集成员按 score 值递增(从小到大)次序排列。
	 * @param key
	 * @param start
	 * @param end
	 * @return
	...
	/**
	 * 
	 * @Description : 返回有序集 key 中，所有 score 值介于下标 start 和 end 之间的成员。有序集成员按 score 值递增(从大到小)次序排列。
	 * @param key
	 * @param start
	 * @param end
	 * @return
	...
	/**
	 * 
	 * @Description : 返回有序集 key 的基数(count)。
	 * @param key
	 * @return
	 */
	...
	/**
	 * 
	 * @Description : 返回或保存给定列表、集合、有序集合 key 中经过排序的元素。
	 * @param key
	 * @return
	 */
	...
	/**
	 * 
	 * @Description : 返回有序集 key 中，所有 score 值介于 min 和 max 之间(包括等于 min 或 max )的成员。有序集成员按 score
	 * 值递增(从大到小)次序排列。<br/>
	 * 
	 * @param key
	 * @param max
	...
	/**
	 * 
	 * @Description : 返回有序集 key 中， score 值介于 max 和 min 之间(默认包括等于 max 或 min )的所有的成员。有序集成员按 score
	 * 值递减(从大到小)的次序排列。<br/>
	 * 可选的 LIMIT 参数指定返回结果的数量及区间(就像SQL中的 SELECT LIMIT offset, count )，注意当 offset
	 * 很大时，定位 offset 的操作可能需要遍历整个有序集，此过程最坏复杂度为 O(N) 时间。
	 * 
	...
	/**
	 * 
	 * @Description : 移除有序集 key 中，指定区间内的所有成员。
	 * @param key
	 * @param start
	 * @param end
	 * @return
	...
	/**
	 * 
	 * @Description : 将值 value 插入到列表 key 当中，位于值 pivot 之前或之后。<br/>
